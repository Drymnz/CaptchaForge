...
public class LessThan extends Operation {
    ...
    public LessThan(AnalyzerSemantico table, ArrayList<ReportErrorInterpreter> listError) {
        super(table, listError);
        // TODO Auto-generated constructor stub
    }

    public DataValue operationLessThan(DataValue valueLeft, DataValue valueRight, Token token) {
