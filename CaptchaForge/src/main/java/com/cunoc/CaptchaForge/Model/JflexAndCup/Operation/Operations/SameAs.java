...
public class SameAs extends Operation {
    ...
    public DataValue operationSameAs(DataValue valueLeft, DataValue valueRight, Token token) {
        ...
        // STRING y STRING
            ...
            String right = valueRight.getValue();
            return new DataValue(String.valueOf(left.equals(right)), ListTypeData.BOOLEAN);
        }
        // STRING y NÚMERO
        ...
        // STRING y CHAR
            ...
            String left = valueLeft.getValue();
            char right = valueRight.getValue().charAt(0);
            return new DataValue(String.valueOf(String.valueOf(left.equals(String.valueOf(right)))), ListTypeData.BOOLEAN);
        }
        ...
        // CHAR y STRING
            ...
            char left = valueLeft.getValue().charAt(0);
            String right = valueRight.getValue();
            return new DataValue(String.valueOf(right.equals(String.valueOf(left))), ListTypeData.BOOLEAN);
        }
